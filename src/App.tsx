...
import { Send, MapPin, Compass, Plane, MessageCircle, RotateCcw } from 'lucide-react';
...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: "Hello! I'm your AI travel assistant. I'm here to help you discover amazing destinations and create personalized itineraries. Tell me about your travel dreams - where would you like to go, what activities interest you, or what kind of experience are you looking for?",
      isUser: false,
      timestamp: new Date(),
    },
  ]);
      ...
      try {
        ...
        if (profile) {
          ...
          setMessages([
            {
              id: '1',
              content: `Hello ${profile.name}! I'm your AI travel assistant. I'm here to help you discover amazing destinations and create personalized itineraries. Tell me about your travel dreams - where would you like to go, what activities interest you, or what kind of experience are you looking for?`,
              isUser: false,
              timestamp: new Date(),
            },
          ]);
  ...
  const handleAuthSuccess = (userData: UserProfile) => {
    setUser(userData);
    // Update the initial message to be personalized
    setMessages([
      {
        id: '1',
        content: `Hello ${userData.name}! I'm your AI travel assistant. I'm here to help you discover amazing destinations and create personalized itineraries. Tell me about your travel dreams - where would you like to go, what activities interest you, or what kind of experience are you looking for?`,
        isUser: false,
        timestamp: new Date(),
      },
    ]);
