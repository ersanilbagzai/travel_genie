    ...
    return (
      <div className="h-full bg-white/80 backdrop-blur-sm border-l border-gray-200/50 flex items-center justify-center p-8">
        <div className="text-left max-w-md mx-auto">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-4">Your Adventure Awaits</h3>
          <p className="text-gray-600 mb-4">
            This is where your personalized travel plan will appear.
          </p>
          <p className="text-gray-600 mb-6">
            As soon as you start chatting with TravelGenie, you’ll see:
          </p>
          <ul className="space-y-3 text-gray-600">
            <li className="flex items-start">
              <Star className="w-5 h-5 mr-3 mt-0.5 text-yellow-400 flex-shrink-0" />
              <span>Tailored itineraries with day-by-day breakdowns</span>
            </li>
            <li className="flex items-start">
              <Utensils className="w-5 h-5 mr-3 mt-0.5 text-orange-400 flex-shrink-0" />
              <span>Local food & hidden gem recommendations</span>
            </li>
            <li className="flex items-start">
              <MapPin className="w-5 h-5 mr-3 mt-0.5 text-purple-400 flex-shrink-0" />
              <span>Cultural experiences and must-see attractions</span>
            </li>
            <li className="flex items-start">
              <Hotel className="w-5 h-5 mr-3 mt-0.5 text-blue-400 flex-shrink-0" />
              <span>Stay suggestions aligned with your style & budget</span>
            </li>
          </ul>
          <p className="mt-8 font-semibold text-gray-700">
            Start your conversation on the left to watch your trip take shape here.
          </p>
        </div>
      </div>
    );
            ...
            <div className="relative pl-8">
              ...
              {data.days.map((day, dayIndex) => (
                <div key={dayIndex} className="relative mb-8">
                  ...
                  <div className="pl-4">
                    <h4 className="font-bold text-lg text-gray-800 mb-4 pt-1">
